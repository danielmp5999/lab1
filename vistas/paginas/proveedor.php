...
//		$registro -> ctrRegistro();
		...
		$registro = ControladorFormularios::ctrRegistroProveedor();
		if ($registro == "ok") {
			echo '<script>
	...
	<div>
		<div class="row">
			<div class="col-md-2">
				<div class="px-1"><a href="index.php?pagina=verproveedores" type="btn" class="btn btn-dark">Mostrar Proveedores</a></div>
			</div>
		</div>
		...
		<li>
			<div class="row">
				<div class="col-md-2">
					<div class="px-1"><a href="index.php?pagina=verproveedorasucursal" type="btn" class="btn btn-dark">Mostrar proveedor a sucursal</a></div>
				</div>
			</div>
		</li>
	</div>
